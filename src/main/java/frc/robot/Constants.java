...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kTrackWidth = Units.inchesToMeters(22); // 14.75 inches for MK
  ...
  public static final class ModuleConstants {
    ...
    public static final double kDrivingFF = 1.5 / kDriveWheelFreeSpeedRps;
    public static final double kDrivingMinOutput = -1;
    public static final double kDrivingMaxOutput = 1;

    public static final double kTurningP = 0.5;
    public static final double kTurningI = 0;
    public static final double kTurningD = 0.25;
